...
public class AuthService implements IAuthService {
    ...
    public String generateAuthUrl(String loginType) {
        ...
        if ("google".equals(loginType)) {
            ...
            // Thêm state parameter để truyền login_type
            urlBuilder.setState("google");
        ...
        //             .queryParam("state", "facebook") // Thêm state cho Facebook
        //             .build().toString();
        // }
        return url;
    }
    ...
    public Map<String, Object> authenticateAndFetchProfile(String code, String loginType) throws IOException {
        ...
        switch (loginType.toLowerCase()) {
            ...
            // restTemplate.getForEntity(urlGetAccessToken, String.class);
